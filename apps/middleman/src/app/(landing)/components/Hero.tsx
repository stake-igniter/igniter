                ...
                <div className="flex flex-col gap-1">
                    ...
                    <div>
                        ...
                        <span className="relative inline-flex items-center justify-center ml-[16px] w-[177px] h-[67px]">
                            <span className="font-[var(--font-mono)] text-[50px] bg-gradient-to-b from-[#e470d9] to-[#967ff4] text-transparent bg-clip-text">
                                $POKT
                            </span>
                            <span className="absolute w-[177px] h-[67px] opacity-15 bg-gradient-to-b from-[#e470d9] to-[#967ff4]">
                            </span>
                        </span>
