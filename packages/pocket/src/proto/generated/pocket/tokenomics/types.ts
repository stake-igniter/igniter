...
export function settlementOpReasonToJSON(object: SettlementOpReason): string {
  switch (object) {
    ...
    case SettlementOpReason.TLM_RELAY_BURN_EQUALS_MINT_VALIDATOR_REWARD_DISTRIBUTION:
      return "TLM_RELAY_BURN_EQUALS_MINT_VALIDATOR_REWARD_DISTRIBUTION";
    case SettlementOpReason.TLM_RELAY_BURN_EQUALS_MINT_DELEGATOR_REWARD_DISTRIBUTION:
      return "TLM_RELAY_BURN_EQUALS_MINT_DELEGATOR_REWARD_DISTRIBUTION";
    ...
    case SettlementOpReason.TLM_GLOBAL_MINT_VALIDATOR_REWARD_DISTRIBUTION:
      return "TLM_GLOBAL_MINT_VALIDATOR_REWARD_DISTRIBUTION";
    case SettlementOpReason.TLM_GLOBAL_MINT_DELEGATOR_REWARD_DISTRIBUTION:
      return "TLM_GLOBAL_MINT_DELEGATOR_REWARD_DISTRIBUTION";
